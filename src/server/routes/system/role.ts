 ...
 *           description: The tenant ID associated with the role
 */
roleRoutes.post("/add", hasPermissions('system.role.create'), validateData(roleSchema), async (req, res) => {
 ...
 */
roleRoutes.put("/:id/edit", hasPermissions('system.role.edit'), validateData(roleSchema), async (req, res) => {
  const idParam = req.params.id;
 ...
 *           description: The tenant ID associated with the role
 */
roleRoutes.post("/validate-code", hasPermissions('system.role.edit'), validateData(roleCodeValidationSchema), async (req, res) => {
