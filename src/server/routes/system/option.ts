 ...
 *           description: The tenant ID associated with the option
 */
optionRoutes.post("/add", hasPermissions('system.option.create'), validateData(optionSchema), async (req, res) => {
 ...
 */
optionRoutes.put("/:id/edit", hasPermissions('system.option.edit'), validateData(optionSchema), async (req, res) => {
  const idParam = req.params.id;
 ...
 *           description: The tenant ID associated with the option
 */
optionRoutes.post("/validate-code", hasPermissions('system.option.edit'), validateData(optionCodeValidationSchema), async (req, res) => {
