...
import { authenticated, authorized, hasPermissions } from 'src/server/middleware/authMiddleware';
 ...
 *           description: The tenant ID associated with the permission
 */
permissionRoutes.post('/add', hasPermissions('system.permission.create'), validateData(permissionSchema), async (req, res) => {
 ...
 */
permissionRoutes.put('/:id/edit', hasPermissions('system.permission.edit'), validateData(permissionSchema), async (req, res) => {
  const idParam = req.params.id;
 ...
 *           description: The tenant ID associated with the permission
 */
permissionRoutes.post("/validate-code", hasPermissions('system.permission.edit'), validateData(permissionCodeValidationSchema), async (req, res) => {
