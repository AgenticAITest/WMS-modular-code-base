                ...
                {roles.map((role, i) => (
                  <TableRow key={role.id}>
                    ...
                    <TableCell className="flex text-center gap-2">
                      <Authorized permissions="system.role.edit">
                        <Tooltip>
                      ...
                      <Authorized permissions="system.role.delete">
                        <Tooltip>
                          <TooltipTrigger asChild>
