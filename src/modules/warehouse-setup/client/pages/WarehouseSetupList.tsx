...
const WarehouseSetupList: React.FC = () => {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your warehouse setup records
          </p>
        </div>
        <Button asChild>
          <Link to="add">
        ...
        <CardHeader>
          ...
          <div className="flex gap-4">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search warehouse setup..."
                value={searchTerm}
...
export default withModuleAuthorization(WarehouseSetupList, {
